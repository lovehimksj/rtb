...
(function (D, aa) {
    ...
    Da.prototype = {
        ...
        init: function (a, b, c, d, e, f) {
            ...
            this.createElement("desc").add().element.appendChild(A.createTextNode(""));
        ...
        buildText: function (a) {
            for (var b =
                    a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString(), f = e.indexOf("<") !== -1,
                     g = b.childNodes, h, i, k, j = P(b, "x"), l = a.styles, m = a.textWidth, n = l && l.lineHeight,
                     q = l && l.textShadow, z = l && l.textOverflow === "ellipsis", s = g.length,
                     G = m && !a.added && this.box, w = function (a) {
                            ...
                            if (e !== " ") {
                                ...
                                if (m) {
                                    for (var q = e.replace(/([^\^])-/g, "$1- ").split(" "),
                                             p = g.length > 1 || f || q.length > 1 && l.whiteSpace !== "nowrap", G, S,
                                             r = [], t = w(s), u = 1, B = a.rotation, y = e, x = y.length;
    ...
    ha.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (r(b)) {
            ...
            h = i[bb]();
            for (var d = i.getTime(), l = i[ab](), m = i[Ua](), n = !g || !!Za,
                     q = (H.day + (g ? Ya(i) : i.getTimezoneOffset() * 6E4)) % H.day; d < c;) e.push(d), k === H.year ? d = jb(h + b * j, 0) : k === H.month ? d = jb(h, l + b * j) : n && (k === H.day || k === H.week) ? d = jb(h, l, m + b * j * (k === H.day ? 1 : 7)) : d += k * j, b++;
            e.push(d);
            p(Ba(e, function (a) {
                return k <=
                    H.hour && a % H.day === q
    ...
    gb.prototype = {
        ...
        getChartSize: function () {
            ...
            this.chartWidth = t(0, b || this.containerWidth > 19 ? this.containerWidth : 1200);
    ...
    Ja.prototype = {
        ...
        destroyElements: function () {
            for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], b,
    ...
    R.prototype = {
        ...
        translate: function () {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis,
                     ...
                     k = i === "between" || J(i), j = a.threshold, l = a.startFromThreshold ? j : 0, m, n, q, p,
                     s = Number.MAX_VALUE, a = 0; a < g; a++) {
                var G = f[a],
                    w = G.x,
                    v = G.y;
                n = G.low;
